...
const makeComputedStyles = ({
    ...
    const indicatorPickerRatio = 42 / 350 // computed from picker image
    ...
    const selectedFullPreviewRatio = 1.40;
    return {
        picker: {
        ...
        pickerIndicator: {
            ...
            width: indicatorSize / 1.3,
            height: indicatorSize /1.3,
        ...
        selectedFullPreview: {
            width: summarySize * selectedFullPreviewRatio,
            height: summarySize * selectedFullPreviewRatio,
            top: pickerSize / 2 - summarySize / 2 * selectedFullPreviewRatio,
            left: pickerSize / 2 - summarySize / 2 * selectedFullPreviewRatio,
            borderRadius: summarySize / 2 * selectedFullPreviewRatio,
            backgroundColor: selectedColor,
        },
    }
}
